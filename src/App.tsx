...
import { FiShield, FiArrowDownCircle, FiArrowUpCircle, FiActivity, FiAward } from 'react-icons/fi';
...
type Tab = 'vault' | 'deposit' | 'withdraw' | 'rewards' | 'activity';
...
const tabs: { id: Tab; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'rewards', label: 'Rewards', icon: <FiAward size={16} /> },
  ...
  return (
    <div className="app-layout">
                ...
                <div className="split-layout">
                  ...
                  <div className="card info-card">
                    ...
                    <ul className="info-list">
                      ...
                      <li>Earn SVT reward tokens automatically (inter-contract call)</li>
      ...
      <footer className="app-footer">
        ...
        <span>Built on Stellar Soroban &bull; Token Vault + SVT Rewards &bull; Green Belt Challenge</span>
      </footer>
    </div>
  );
};
